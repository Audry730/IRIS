...
Nous allons nous intéresser au rendement des fermes à oursins et mettre en évidence le lien entre milieu de croissance et rendement. Le rendement est calculé à partir des données présentes dans le package urchin. Le calcul se réalise en soustrayant la masse des parties solides à la masse totale. De cette façon, il ne restera que la masse de chaires de l'oursin.
...
Le troisième graphe permet de visualiser les différneces de tailles qui existent entre oursins élevés et oursins pêchés. On remarque que les oursins pêchés sont plus petits que ceux élevés.
