...
On voit que ce sont les oursins de fermes qui seront les plus développés.  
...
Les oursins qui ont grandis en milieu naturel n'auront pas une aussi grande masse maximale que ceux qui ont grandis dans une ferme.  
...
On peut voir içi que que ceux issus de la pêche ont une taille un tout petit peu plus petite mais ceux élevés ont une masse beaucoup plus importante !
...
Grace à ce graphique on peut avoir une idée de quelle méthode est la plus rentable. Si on veut les oursins les plus gros pour les manger par exemple ceux de ferme seront mieux, à voir si le skelette ou une autre partie de l'oursin non commestible ne fausse pas ce résultat.
